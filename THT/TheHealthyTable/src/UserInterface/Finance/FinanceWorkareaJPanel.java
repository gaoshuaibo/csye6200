...
import UserInterface.CustomerService.*;
...
public class FinanceWorkareaJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        btFinanceReport = new javax.swing.JButton();
        ...
        btFinanceReport.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        btFinanceReport.setText("View Finance Report");
        btFinanceReport.setPreferredSize(new java.awt.Dimension(170, 40));
        btFinanceReport.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btFinanceReportActionPerformed(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 0;
        jPanel1.add(btFinanceReport, gridBagConstraints);
    ...
    private void btFinanceReportActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btFinanceReportActionPerformed
        // TODO add your handling code here:
        ViewFinanceReportJPanel panel = new ViewFinanceReportJPanel();
        userProcessContainer.add("ViewFinanceReportJPanel", panel);
        CardLayout layout = (CardLayout) userProcessContainer.getLayout();
        layout.next(userProcessContainer);
    }//GEN-LAST:event_btFinanceReportActionPerformed


    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JButton btFinanceReport;
